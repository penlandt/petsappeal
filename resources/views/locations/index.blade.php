        ...
        <h2 class="font-semibold text-xl text-gray-900 dark:text-gray-100 leading-tight">
            ...
            <span class="relative inline-block align-middle ml-2" x-data="{ show: false }">
                ...
                <div x-show="show" x-cloak
                    ...
                    Locations are where the work of grooming, boarding, and retail get done. PETSAppeal easily supports independent businesses with one location or enterprises with multiple locations.
                </div>
            </span>
        </h2>
    </x-slot>
