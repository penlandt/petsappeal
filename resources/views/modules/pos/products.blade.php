<x-app-layout>
            ...
            <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-1 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Cost</th>
                        <th class="px-4 py-1 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Stock</th>
    ...
    @foreach ($products as $product)
        <tr class="product-row border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="px-4 py-0 text-sm text-gray-800 dark:text-gray-100">${{ number_format($product->cost, 2) }}</td>
            <td class="px-4 py-0 text-sm text-gray-800 dark:text-gray-100">{{ $product->stock_quantity }}</td>
