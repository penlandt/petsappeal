...
class ResourceTimelineViewLayout extends internal_cjs.BaseComponent {
    ...
    render() {
        ...
        return (preact_cjs.createElement(internal_cjs$3.ScrollGrid, { ref: this.scrollGridRef, elRef: this.rootElRef, liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: false, colGroups: [
